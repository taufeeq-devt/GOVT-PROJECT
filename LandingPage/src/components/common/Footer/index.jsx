...
const Footer = () => (
  <footer className={`bg-gradient-to-r from-dark-bg via-dark-surface to-dark-bg text-main py-8 sm:py-12 md:py-16 border-t border-slate-700 mt-16 sm:mt-20 md:mt-24 rounded-t-3xl shadow-2xl ${styles.footer}`}>
