...
const menu = [
  ...
  { name: 'View Bids & Assign', icon: <Gavel size={22} />, to: '/view-bids', color: 'border-teal-500' },
  { name: 'Assign Supervisor & Supplier', icon: <Users size={22} />, to: '/assign-supervisor-supplier', color: 'border-orange-500' },
