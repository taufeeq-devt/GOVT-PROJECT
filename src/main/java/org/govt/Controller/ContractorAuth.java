...
public class ContractorAuth {
    ...
    public Register register(@RequestBody User_contractor user1){
        return user.registerContractor(user1.getName(),user1.getUsername(),user1.getPassword(),user1.getAge(),user1.getPhone(),user1.getEmail(),user1.getGst_number(),user1.getAddress());
    }
